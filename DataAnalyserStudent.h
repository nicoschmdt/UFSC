...
public:
    ...
    * O primeiro e o último pontos (pontos 0 e n-1) são iguais (uma média deles e 0 pontos antes e depois).
        O segundo e o penúltim o pontos (1 e n-2) devem ser a média deles e 1 ponto antes e 1 ponto depois,
        e assim do ponto 0 até o ponto k-1 e do ponto n-1 retrocedendo até o ponto n-k.
